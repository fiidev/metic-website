    ...
    <>
      <div className="relative pb-35 bg-secondary">
        <div className="text-center pt-21">
          <Image
            src="https://res.cloudinary.com/stt7o3mb/image/upload/v1784892600/assets/image/cakar-kiri.png"
            width={92}
            height={102}
            alt="Cakar Kiri"
          ...
          />
          <Image
            src="https://res.cloudinary.com/stt7o3mb/image/upload/v1784892598/assets/image/cakar-kanan.png"
            width={92}
            height={102}
            alt="Cakar Kiri"
